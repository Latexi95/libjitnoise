...
///
/// The noise module classes that are included in jitnoise can be roughly
...
public:
    ...
    /// Constructor.
    Module (int sourceModuleCount, CodeGenerator *codeGenerator);
    ...
    virtual const Module& GetSourceModule (int index) const
    {
        ...
        assert(index < GetSourceModuleCount () && index >= 0 && m_pSourceModule[index] != NULL);
    ...
    {
        assert (m_pSourceModule != NULL);
        assert(index < GetSourceModuleCount () && index >= 0);
        m_pSourceModule[index] = &sourceModule;
    }



    CodeGenerator *GetCodeGenerator() const { return m_CodeGenerator; }
